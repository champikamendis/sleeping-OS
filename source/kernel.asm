;SleepingOs --- The SleepingOs Operating System Kernel
;===================================================================

	BITS 16
	%DEFINE SleepingOs_VER '1.0.0'	 ;OS version number
	%DEFINE SleepingOs_API_VER 1	; API version for programs to check
	%DEFINE KEY_ESC		27
...
os_main:
	...
	mov es, ax			; segments ever again, as SleepingOs and its programs
...
option_screen:
	...
	os_init_msg		db '--------------------------Welcome to SleepingOs----------------------------', 0
	os_version_msg		db 'Version ', SleepingOs_VER, 0

	os_init_msg2		db '                         Hardware Information                               ', 0
	os_version_msg2		db 'Version ', SleepingOs_VER, 0

	dialog_string_1		db 'Welcome to SleepingOs Operating System', 0
	dialog_string_2		db 'Please select View for HardwareInfo or', 0
	dialog_string_3		db 'select Quit for quit the OS.', 0
